          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="ftco-nav">
              <ul className="navbar-nav m-auto">
                ...
                <Link class="dropdown-item" to="/new-invoice">Sales Invoice</Link>
                <Link class="dropdown-item" to="/new-purchase-invoice">Purchase Invoice</Link>
                <div class="dropdown-divider"></div>
                <Link class="dropdown-item" to="/aged-payable-table">Purchase Overview</Link>
